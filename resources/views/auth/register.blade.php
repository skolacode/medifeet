                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control" name="address"      value="{{ old('address') }}" placeholder="eg: No3, Jln  Tun Razak, ..." maxlength="180" rows="4" cols="30" required>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::label('role', 'Assign as', [ 'class'=>'col-md-4 control-label']) !!}

                            <div class="col-md-6">
                                {!! Form::select('role_id', App\Role::pluck('name', 'id'), '', [ 'class'=>'form-control' ,'placeholder'=>'Please Select...', 'required']) !!}
                            </div>
